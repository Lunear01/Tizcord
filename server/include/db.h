...
/* Channel */
int db_create_channel(DbContext* db, int64_t server_id, const char* name, sqlite3_int64* channel_id_out);
int db_get_channel_id(DbContext* db, int64_t server_id, const char* name, sqlite3_int64* channel_id_out);
...
/* Social */
int db_send_friend_request(DbContext* db, int64_t user_id, sqlite3_int64 friend_id);
int db_accept_friend_request(DbContext* db, int64_t requester_id, sqlite3_int64 accepter_id);
int db_reject_friend_request(DbContext* db, int64_t requester_id, sqlite3_int64 rejecter_id);
int db_remove_friendship(DbContext* db, int64_t user_id, sqlite3_int64 friend_id);
